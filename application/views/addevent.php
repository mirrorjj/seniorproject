                        ...
                        <?php echo form_open('user/addevent'); ?>
                            ...
                            <div class="row control-group">
                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                    ...
                                    <input type="text" class="form-control" placeholder="ผู้จัดกิจกรรม" name="event_who_create" required data-validation-required-message="Please enter your event who create.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br>
